...
class DecoderLayer(nn.Module):
    ...
    def forward(self, x, y, en_vm_attention_outer_list, adj, instances_index_vm, trend_init, attn_mask=None):
        """
...
class Decoder(nn.Module):
    ...
    def forward(self, x, y, en_vm_attention_outer_list, adj, instances_index_vm, trend_init):
        """
        ...
        for decoder_layer in self.decoder_layer_stack:
            x, x_trend, vm_attention_list = decoder_layer(x, y, en_vm_attention_outer_list, adj, instances_index_vm, trend_init)
