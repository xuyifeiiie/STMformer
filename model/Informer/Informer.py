...
from layer.Transformer_EncDec import Decoder, DecoderLayer, Encoder, EncoderLayer, ConvLayer
    ...
    def __init__(self, configs, device):
        ...
        self.encoder = Encoder(
            ...
            [
                ConvLayer(
                    configs.d_model
                ) for l in range(configs.num_en_layers - 1)
        ...
        self.decoder = Decoder(
            ...
            norm_layer=torch.nn.LayerNorm(configs.d_model),
            projection=nn.Linear(configs.d_model, configs.num_features, bias=True)
        )
        ...
        if self.task_name == 'classification':
            ...
            self.projection = nn.Linear(configs.d_model * configs.history_steps, configs.num_class)
